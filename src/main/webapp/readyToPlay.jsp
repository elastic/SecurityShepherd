...
<body>
	...
	<div class="points">
		...
		<table>
			...
			<tr>
				<td>Don’t mute the messenger - Spread the word about the CTF and get someone to sign up</td>
				<td>20</td>
			</tr>
			<tr>
				<td>Popup Points - Trigger an XSS alert box where the CTF platform doesn't award points (1 payload per person)</td>
				<td>30</td>
			</tr>
			<tr>
				<td>Proxy Pals - Help a group or an individual figure out how to use Burp Suite</td>
				<td>50</td>
			</tr>
			<tr>
				<td>It was like that when I got here - report a valid security issue against the CTF platform to the Product Security Team</td>
				<td>70</td>
			</tr>
			<tr>
				<td>OWASP is that? - Help a group or an individual understand any security issue in the CTF e.g. XSS, CSRF, Injection etc. where that person or group is able to complete a level based on your teaching.</td>
				<td>100</td>
			</tr>
		</table>
		<br />
